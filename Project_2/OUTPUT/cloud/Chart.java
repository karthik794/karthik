...
public class Chart extends ApplicationFrame{
	static long response,wait;
	static String title;
public Chart(String paramString,long r,long w){
	super(paramString);
	response = r;
	wait = w;
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(response,"Response Time","Response Time");
	localDefaultCategoryDataset.addValue(wait,"Waiting Time","Waiting Time");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title, "Response & Waiting Time", "Time (M.S)", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
